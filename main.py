...
def run_real_test():
    """Executes the real_test.py file located in the same folder."""
    test_file = os.path.join(os.path.dirname(__file__), "real_test.py")
    if os.path.exists(test_file):
        print("\n=== [Main] Running real_test.py ===")
        ...
        print(result.stdout)
        if result.stderr:
            print("Errors during real_test.py execution:\n", result.stderr)
    else:
        print("real_test.py not found in the current folder.")
